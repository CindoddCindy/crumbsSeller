...
public class SellerProfile extends Fragment {
    ...
    private Button button_logout_seller;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         ...
         button_logout_seller=view.findViewById(R.id.btn_logout_seller);
         button_logout_seller.setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View v) {
                 Intent intent = new Intent(getActivity(), RegisSeller.class);
